...
<?php	for($i=0;$i<count($result);$i++)
	{ 
		$dis_string.="<tr>";
		$dis_string.="<td><a href='javascript:' client_id='".$result[$i]['client_id']."' date='".$result[$i]['date']."' 	place='".$result[$i]['place']."' f_name='".$result[$i]['f_name']."' l_name='".$result[$i]['l_name']."'  mobile_no='".$result[$i]['mobile_no']."' email1='".$result[$i]['email1']."'  class='select_broker'>Select</a></td>";
