...
<h1>Owner View</h1>
<form name="frm" method="post" action="index.php?rel=owner_action" >
...
<table width="80%" border="0" cellspacing="2" cellpadding="2"> 
 ...
 <tr>
     ...
     <tr>
	    ...
	    <td class="black11" colspan="2"><?php  if($client_data[0]['newspaper']=='2') { ?>  Newspaper Advertise <?php } ?> </td>
	</tr>
	<tr>	    
	    <td class="black11" colspan="2"><?php  if($client_data[0]['friends']=='3' ) { ?>  Friends/Relatives <?php } ?> </td>
	     
	     <td class="black11" colspan="2"><?php  if($client_data[0]['other']=='4'  ) { ?>  Other <?php } ?> </td>
  </tr>
 ...
 <!-- <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td class="black11"><a href="index.php?rel=edit_owner&id=<?php echo $client_data[0]['client_id']?>"><input type="button" name="submit" onclick="return validate();" value="<?=$mode;?> Owner" /></a>&nbsp;<a href="index.php?rel=edit_owner_property&owner_id=<?php echo $client_data[0]['client_id']?>"><input type="button" name="addproperty"  value="Add Property" /></a>&nbsp;<!--<input type="button" name="cancel" onclick="javascript:window.location='index.php?rel=common_listing&module=static_pages';" value="Cancel" />--></td>
  </tr>
</table>
</form>
