...
<tr>
	<td class="black11" >Suburb/Locality</td>
	<td class="black11">
...
<tr>    
	<td class="black11" >Sector</td>
	<td class="black11">
		<input name="sector" type="text" placeholder="Eg: Sector 11" />
	</td>
</tr>
...
<tr>
	...
	<td class="black11">
		<input name="near_building" id="building" type="text" placeholder="choose from suggestions.." />
	</td>
</tr>
<tr>
	<td class="black11">
		<input type="checkbox" name="is_choice_flex" value="1">My requirements are flexible to a radius of <input type="number" name="flex_distance" min="1" max="10"> Km from 
	</td>
	<td class="black11">
		<select name="flex_pref"><option value="building">Building</option><option value="sublocality">Sublocality</option></select>
	</td>
</tr>
<?php if($mode=='Add') { ?>
